...
describe("Multipool library", function() {
    ...
    it("Mint with deviation fee and depeg base fee", async function() {
        await test2.mintWithDeviationFeeAndDepegBaseFee();
    });
    it("Mint with deviation fee and depeg base fee  reversed", async function() {
        await test2.mintWithDeviationFeeReversedAndDepegBaseFee();
    });
    it("Burn with deviation fee and depeg base fee reversed", async function() {
        await test2.burnWithDeviationFeeReversedAndDepegBaseFee();
    });
    it("Burn with deviation fee and depeg base fee", async function() {
        await test2.burnWithDeviationFeeAndDepegBaseFee();
    });
});
