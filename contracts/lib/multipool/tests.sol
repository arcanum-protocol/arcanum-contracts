...
contract TestMultipoolMath {
    ...
    function burnWithDeviationFeeReversed() public {
        ...
        MpContext memory resultContext = MpContext({
            totalCurrentUsdAmount:  ud(1000e18) - ud(5005866126138531618) * ud(10e18),
            totalAssetPercents:     ud(100e18),
            curveCoef:              ud(0.0003e18),
            deviationPercentLimit:  ud(0.1e18),
            operationBaseFee:       ud(0.0001e18),
    ...
    function burnWithDeviationFee() public {
        ...
        MpContext memory resultContext = MpContext({
            totalCurrentUsdAmount:  ud(1000e18) - ud(5005866126138531618 - 397) * ud(10e18),
            totalAssetPercents:     ud(100e18),
            curveCoef:              ud(0.0003e18),
            deviationPercentLimit:  ud(0.1e18),
            operationBaseFee:       ud(0.0001e18),
...
contract TestMultipoolMathCorner {
    ...
    function mintTooMuch() public {
        ...
        MpAsset memory resultAsset = MpAsset({
            ...
            collectedCashbacks: ud(10e18+5000.0005e18 - 2499952891208199 - 24999528912081994491),
            percent:            ud(50e18)
        });
    ...
    function mintTooMuchReversed() public {
        ...
        MpAsset memory resultAsset = MpAsset({
            ...
            price:              ud(10e18),
            collectedFees:      ud(2499952891208199),
            collectedCashbacks: ud(10e18 + 5000000499999930836640 - 2499952891208199 - 24999528912081994491),
            percent:            ud(50e18)
        });
